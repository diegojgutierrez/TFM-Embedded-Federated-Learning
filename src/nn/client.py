...
class NNClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        scores = utils.keras_cv(self.model, parameters, metrics_labels, skf.split(X_cv, y_cv), X_cv, y_cv, epochs, batch_size)
    ...
    def evaluate(self, parameters, config):
        ...
        if cnf.SAVE:
            self.model.save('../../models/NeuralNet/my_model.h5')
...
def main():
    ...
    # Resample data
    X_fcv, y_fcv = utils.sample_data(X_cv, y_cv)
