...
learning_rates = hcnf.auto_config.learning_rates
batch_size = hcnf.auto_config.batch_size
epochs = hcnf.auto_config.epochs
layers = hcnf.auto_config.layers
modelName = hcnf.auto_config.name
        ...
        for batch in batch_size:
            for epoch in epochs:
                for lr in learning_rates:
                    ...
                    m = len(var)
                    model = utils.hyper_auto(m, ['acc'], encoder, decoder, config["learning_rate"])
